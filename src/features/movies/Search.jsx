    ...
    <AppLayout>
      <div className="maxW padX py-12 max-md:py-8">
        <form
          ...
          className=" flex items-center mt-20 mb-10 w-full mx-auto"
        >
          <input
            type="text"
            value={initialQuery}
            ...
            className="border-b-2 border-b-white border-opacity-80 focus:border-b-red w-full outline-none bg-transparent text-2xl max-lg:text-xl max-md:text-base max-sm:text-sm tracking-wide px-1"
          />
          <span
            onClick={handleClearInput}
            className="text-lg -ml-20 flex items-center gap-x-1 cursor-pointer text-red font-poppinsMedium max-sm:hidden"
          >
            Cancel
          </span>
        </form>
